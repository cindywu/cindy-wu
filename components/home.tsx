  ...
  return (
    <div className={styles.container}>
      ...
      <div>
        ...
        <p>In a past life I did science hatching seamonkeys to feed to zebrafish for tuberculosis research, camped under the stars in the eastern washington sagebrush steppe counting insect galls, built logic gates to silence genes using DNA, designed an anthrax therapeutic for the U.S. Army, and programmed immune cells for a universal vaccine.</p>
        <p>This time spent produced currency in the form of peer-reviewed papers.</p>
        <p>For a decade I poured all my labor into breathing life into <Link href="http://experiment.com">Experiment</Link> with my best friend Denny.
        </p>
