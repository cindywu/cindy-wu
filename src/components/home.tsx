      ...
      <div className={"p-4 max-w-md"}>
        ...
        <div className={"flex-row font-light"}>
          ...
          <div className={"pt-3"}>
            ...
            programmed immune cells for a universal vaccine.
          </div>
          <div className={"pt-3"}>
          ...
          <div className={"pt-3"}>
            ...
            to America from the island of Taiwan.
          </div>
          <div className={"pt-3"}>
            San Francisco and New York City are places I have called home.
            Today, the Kingdom of Haiwaiʻi is home.
          </div>
          <div className={"pt-3"}>
            I ride a {`9'2"`} Takayama DT-2 and a {`9'11"`} Byzak. You can find
            me at first light half a mile offshore of Waikīkī.
          </div>
          <div className={"pt-3"}>
        ...
        <div className={"text-sm font-normal pt-1 text-zinc-500"}>
          ...
          {showLastUpdated && (
            <span className={"pl-2"}>
              ...
              {parseInt(
                ((((new Date() as any) -
                  (new Date(statuses[0][1].date) as any)) as any) /
                  1000 /
                  60) as unknown as any
              )}{" "}
              min ago)
            </span>
          )}
