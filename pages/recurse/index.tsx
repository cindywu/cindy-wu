...
export default function index() {
  return (
    <div className={"p-4 dark:bg-zinc-800 h-screen"}>
      ...
      <Link className={"no-underline hover:underline"} href="https://github.com/cindywu/mahjong-2"><div>multiplayer mahjong with real-time video chat baked in to 練習中文</div></Link>
    </div>
  )
}
